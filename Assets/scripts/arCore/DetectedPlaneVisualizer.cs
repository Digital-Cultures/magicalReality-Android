    ...
    public class DetectedPlaneVisualizer : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            if(Global.bearingSet){
                m_MeshRenderer.enabled = Global.showGrid;
                //Color colorNow=m_MeshRenderer.material.color;
               // m_MeshRenderer.material.color=colorNow;
            }else{
               m_MeshRenderer.enabled = false;
            }
        ...
        public void Initialize(DetectedPlane plane)
        {
            ...
            if(Global.bearingSet){
                m_MeshRenderer.material.SetColor("_GridColor", k_PlaneColors[10]);//s_PlaneCount++ % k_PlaneColors.Length
                Color colorNow=m_MeshRenderer.material.color;
                colorNow.a=0.5f;
                m_MeshRenderer.material.color=colorNow;
            }
